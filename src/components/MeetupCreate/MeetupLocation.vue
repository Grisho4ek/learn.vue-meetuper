<template>
  <div>
    ...
    <div class="m-b-lg">
      ...
      <a v-if="ipLocation && !wantChangeLocation" @click.prevent="toggleLocation">(change location)</a>
      <a v-if="ipLocation && wantChangeLocation" @click.prevent="toggleLocation">(set default location)</a>
