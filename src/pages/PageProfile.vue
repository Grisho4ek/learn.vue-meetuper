      ...
      <div class="section profile-heading">
        <div class="columns is-mobile is-multiline">
          ...
          <div @click="activeTab = 'meetups'"
               :class="{ 'is-active' : activeTab === 'meetups' }"
          ...
          <div @click="activeTab = 'threads'"
               :class="{ 'is-active' : activeTab === 'threads' }"
               class="stats-tab column is-2-tablet is-4-mobile has-text-centered">
...
export default {
  ...
  methods: {
    ...
    submitedUser({ user, done }){
      this.$store.dispatch('auth/updateUser', user)
        .then(() => {
          this.$toasted.success('Profile Succesfully Updated', {duration: 3000})
          done()
        })
        .catch((errorMessage) => {
